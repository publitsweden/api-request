...
describe('Request', () => {
    ...
    describe('index()', () => {
        it('should make a request', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const request = yield new PublitApiRequest('things')
    ...
    describe('show()', () => {
        it('should make a show request', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const request = yield new PublitApiRequest('things').show('123321');
    ...
    describe('store()', () => {
        it('should make a store request', () => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockResponse(JSON.stringify({ id: '123321' }));
            const request = yield new PublitApiRequest('things').store({
                hello: 'goodbye',
            });
            expect(request).toMatchObject({ id: '123321' });
    ...
    describe('update()', () => {
        it('should make an update request', () => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockResponse(JSON.stringify({ id: '123321' }));
            const request = yield new PublitApiRequest('things').update('123321', {
                hello: 'goodbye',
            });
            expect(request).toMatchObject({ id: '123321' });
            expect(fetch).toHaveBeenLastCalledWith('https://api.publit.com/publishing/v2.0/things/123321', expect.objectContaining({
    ...
    describe('delete()', () => {
        it('should make a delete request', () => __awaiter(void 0, void 0, void 0, function* () {
            fetch.mockResponse(JSON.stringify({ id: '123321' }));
            const request = yield new PublitApiRequest('things').delete('123321');
            expect(request).toMatchObject({ id: '123321' });
            expect(fetch).toHaveBeenLastCalledWith('https://api.publit.com/publishing/v2.0/things/123321', expect.objectContaining({
                method: 'DELETE',
            }));
    ...
    describe('error handling', () => {
        ...
        it('should throw error on 401 response', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect.assertions(2);
            try {
                yield new PublitApiRequest('resource', {
                    onError: handleError,
                }).index();
            }
            catch (e) {
